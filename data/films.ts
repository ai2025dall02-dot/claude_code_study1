...
export const films: Film[] = [
  ...
  },
  {
    ...
    genre: "드라마",
    logline:
      "매일 밤 바닷물이 문턱까지 차오르는 집. 떠난 이의 방을 비우지 못한 남매가 마지막 만조를 함께 기다린다.",
    status: "2025 라인업",
  ...
  },
  {
    ...
    genre: "다큐멘터리",
    logline:
      "버려진 과수원을 되살리는 노부부. 카메라는 한 그루의 나무가 다시 열매를 맺기까지의 네 계절을 조용히 지켜본다.",
    status: "배급 중",
  ...
  },
  {
    ...
    genre: "미스터리",
    logline:
      "라디오 주파수 사이에서 사라진 목소리를 좇는 엔지니어. 어느 밤, 도시의 모든 소음이 하나의 문장을 이루기 시작한다.",
    status: "2025 라인업",
  ...
  },
  {
    ...
    genre: "드라마",
    logline:
      "필사의 시대가 저문 도시, 마지막 필경사가 자신의 손글씨를 아들에게 물려주려 한다. 잉크가 마르기 전에.",
    status: "배급 중",
  ...
  },
  {
    ...
    genre: "실험·에세이",
    logline:
      "하루가 가장 긴 도시와 가장 짧은 도시를 잇는 야간열차. 두 시간대 사이에서 승객들은 같은 꿈을 나눠 꾼다.",
    status: "2024 부산국제영화제 초청",
  ...
  },
  {
    ...
    genre: "로드무비",
    logline:
      "산불이 지나간 마을로 돌아온 자매. 잿더미 속에서 타지 않은 단 하나의 물건을 찾아 다시 길을 나선다.",
    status: "배급 중",
