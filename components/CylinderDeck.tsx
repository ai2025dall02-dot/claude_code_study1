...
const CENTER_Y = 2.3; // [3] 세로 위치 — 더 눕힌 만큼 위로 더 올려 담음(월드 Y)
...
const PANEL_COLOR = "#f2f2f2"; // 빈 뒷판 유리판 — 거의 흰색(옅은 회색)
const PANEL_BORDER = "rgba(255,255,255,0.95)"; // 얇고 밝은 테두리
const PANEL_OPACITY = 0.42; // 은은한 반투명(0.35~0.5)
